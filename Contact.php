                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td width="95%"><p class="style1"><strong>Head Police Station</strong></p>
                                <p class="style1"><strong>Dhanmondi 8/A</strong></p>
                                <p class="style1"><strong>Dhaka</strong></p></td>
                        </tr>
                        <tr>
                            <td><img src="images/call.png" width="32" height="32" /></td>
                            <td><p class="style1"><strong>+8801932134942</strong></p>
                                <p class="style2">+8801515279786</p></td>
                        </tr>
                        <tr>
                            <td><img src="images/mail.png" width="32" height="32" /></td>
                            <td><span class="style1"><strong>crimemanagement@gmail.com</strong></span></td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
